const getImg =
  "https://api.unsplash.com/photos/random/?client_id=wih7wamrEKtJE5lCUQVZ74fo8Dgrsk7hA1x4CrmFnGQ";

fetch(getImg)
  .then((response) => response.json())
  .then((result) => console.log(result))
  .catch((error) => {
    console.error("이미지 로드 중 오류발생", error);
  });
...
lists.forEach((list) => {
  ...
  play.addEventListener("click", (e) => {
    ...
    if (isActive) {
      ...
      activeAudio = e.currentTarget.closest("article").querySelector("audio");
